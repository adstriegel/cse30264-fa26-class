# Lecture 3 - Application Layer (L7) - 08-31-26
...
Browse Chapter 2 in the book. If you do not have the Kurose / Ross book yet, you can access the free Peterson / Davies book and read through Chapter 9 in that book.

As you are reading about the Application Layer, think about the following questions:
...
* [Homework 2](../../homework/hw02/hw02.md)
...
* Finish Reading Chapter 2 - Application Layer (Kurose / Ross)
   * If you are using the Peterson / Davies book, read Chapter 9
* Wednesday - Lecture 4 - Application Layer (continued))
* Next Monday - Lecture 5 - Overview of the Transport Layer
